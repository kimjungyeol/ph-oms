...
import com.ktnet.fta.details.document.service.DetailsDoService;
...
@Component
public class DetailsDoGenerator {

    @Resource(name = "detailsDoService")
    private DetailsDoService detailsDoService;
    ...
    public void generate(Map<String, Object> map) {
        // 문서 기존 group id 가져오기
        Long beforeGroupId = detailsDoService.searchGroupId(map);
        ...
        // 문서에 group id 반영
        detailsDoService.updateGroupId(map);
        ...
        try {
            ...
            detailsDoService.updateStatus(map);
        } catch (Exception e) {
            // 상태 수정
    ...
    private void generateDetails(Map<String, Object> map) {
        // 품목 명세 생성
        detailsDoService.insertDetailsItem(map);
    ...
    private void generateEo(Map<String, Object> map) {
        // 소명서 생성
        detailsDoService.insertExplainOrigin(map);
